...
main_dict = { 'directories': {'root_dir': '/data/bahrdoh/Deep_Learning_Pipeline', #'//zkh/appdata/RTDicom/Projectline_HNC_modelling/Users/Hooman Bahrdo/Models/Deep_Learning/DL_NTCP_Xerostomia',
                              ...
                              'experiments':{ 'root_dir': '/data/sama/Deep_Learning_Pipeline/experiments/test',
                                              'src_folder': 'src',
              ...
              'data_preprocessing':{ 'augmentation_function': 'call_aug_transform_1',
                                    ...
                                    'augmentation':{'perform_data_aug': True,
                                                     },
                                    ...
                                    'cropping': {'crop_prob': 1.0, # Probability for cropping
                                                 'cropping_dim': [128,128,128],
                                                 'num_sample': 4
                                                },
                                    'translocation': {'coord_prob': 1.0, # probability for translocation
                                                      'num_coordinations': 3, # Number of random coordination generator
                                                },
                                    ...
                                    'elastic_deformation':{'elastic_prob': 1.0, # probability for elastic deformation
                                                           'sigma_elastic': (8, 8),
