...
main_dict = { 'directories': {'root_dir': '/data/bahrdoh/Deep_Learning_Pipeline', #'//zkh/appdata/RTDicom/Projectline_HNC_modelling/Users/Hooman Bahrdo/Models/Deep_Learning/DL_NTCP_Xerostomia',
              ...
              'device': { 'wandb_mode': 'disabled', # 'online' | 'offline' | 'disabled' # Is a nice platform that helps visualize the model performance
              ...
              'data': { 'n_input_channels': 1,
                        ...
                        'val_frac': 0.4,  # training-internal_validation-test split. The same test set will be used for Cross-Validation.
